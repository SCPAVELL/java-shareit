...
public class BookingServiceImpl implements BookingService {
	...
	public List<BookingDto> getBookingsByOwner(Long userId, String state) {
		...
		case "CURRENT":
			...
			break;
		case "PAST":
			bookingList = bookingRepository.findAllByItemOwnerIdAndEndBeforeOrderByStartDesc(userId,
					LocalDateTime.now());
			break;
		case "FUTURE":
			bookingList = bookingRepository.findAllByItemOwnerIdAndStartAfterOrderByStartDesc(userId,
					LocalDateTime.now());
			break;
		case "WAITING":
