...
import ru.practicum.shareit.common.storage.BookingRepository;
import ru.practicum.shareit.common.storage.BookingServiceImpl;
...
class BookingServiceImplTest {
	...
	void addBooking_whenItemNotAvailable_thenValidationExceptionThrown() {
		...
		assertThrows(ResourceValidationException.class, () -> bookingService.addBooking(dto, bookerId));
	...
	void addBooking_whenUserIsOwner_thenNotFoundExceptionThrown() {
		...
		assertThrows(ResourceNotFoundException.class, () -> bookingService.addBooking(dto, bookerId));
	...
	void updateBooking_whenUserIsNotOwner_thenResourceNotFoundExceptionThrown() {
		...
		assertThrows(ResourceNotFoundException.class, () -> bookingService.updateBooking(ownerId, bookingId, approved));
	...
	void getUserBookingByUserId_whenUserNotOwnerOrBooker_thenResourceNotFoundExceptionThrown() {
		...
		assertThrows(ResourceNotFoundException.class, () -> bookingService.getBookingByUserId(bookingId, userId));
	}
	...
	void getAllUserBookingsByState_whenStateIsCurrent_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByBookerIdAndStartLessThanEqualAndEndGreaterThanEqualOrderByStartDesc(anyLong(),
				any(), any(), any());
	}
	...
	void getAllUserBookingsByState_whenStateIsFuture_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByBookerIdAndStartAfterOrderByStartDesc(anyLong(), any(), any());
	}
	...
	void getAllUserBookingsByState_whenStateIsPast_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByBookerIdAndEndBeforeOrderByStartDesc(anyLong(), any(), any());
	}
	...
	void getAllUserBookingsByState_whenStateIsWaiting_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByBookerIdAndStatusOrderByStartDesc(anyLong(), any(), any());
	}
	...
	void getAllOwnerBookingsByState_whenStateIsFuture_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByItemOwnerIdAndStartAfterOrderByStartDesc(anyLong(), any(), any());
	}
	...
	void getAllOwnerBookingsByState_whenStateIsPast_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByItemOwnerIdAndEndBeforeOrderByStartDesc(anyLong(), any(), any());
	}
	...
	void getAllOwnerBookingsByState_whenStateIsWaiting_thenAccordingRepositoryMethodInvoked() {
		...
		verify(bookingRepository).findByItemOwnerIdAndStatusOrderByStartDesc(anyLong(), any(), any());
	}
	...
	void getLastBooking_whenInvoked_thenReturnLastBooking() {
		...
		Booking lastBooking = Booking.builder().booker(booker1).start(past.minusHours(1)).end(past.plusHours(1))
				.build();
		User booker2 = new User();
		Booking nextBooking = Booking.builder().booker(booker2).start(future.minusHours(1)).end(future.plusHours(1))
				.build();
